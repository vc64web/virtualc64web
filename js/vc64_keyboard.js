...
function installKeyboard() {  
    ...
    [{k:'CTRL',c:'ControlLeft', cls:'ctrl'}, {k:'Q', p:'\u{2022}',cbm:'\u{251c}' },{k:'W', p:'\u{25cb}',cbm:'\u{2524}'},{k:'E', p:'\u{e0c5}',cbm:'\u{2534}'},{k:'R', p:'\u{e072}',cbm:'\u{252c}'},{k:'T', p:'\u{e0d4}',cbm:'\u{2594}'},{k:'Y', p:'\u{e0d9}',cbm:'\u{e0b7}'},{k:'U', p:'\u{256d}',cbm:'\u{e0b8}'},{k:'I', p:'\u{256e}',cbm:'\u{2584}'},{k:'O', p:'\u{e0cf}',cbm:'\u{2583}'},{k:'P', p:'\u{e0d0}',cbm:'\u{2582}'},{k:'@',c:'BracketLeft',slc:'&radic;'},{k:'*', c:'BracketRight'},{k:'\u{2191}',c:'upArrow'},{k:'RESTORE', c:'restore',style:'font-size:small'}], 
