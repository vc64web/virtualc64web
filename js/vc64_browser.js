        ...
        run: function (app_title, id){
            ...
            for(var link of item.links)
            {
                ...
                <button type="button" data-toggle="tooltip" data-placement="bottom" title="copy to clipboard for sharing"
                  ...
                  class="btn btn-secondary btn-sm" id="copy_${link_id}"><svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-clipboard-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
