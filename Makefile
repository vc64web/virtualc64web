...
LFLAGS= -s WASM_BIGINT  -O3 -s USE_SDL=2 $(WASM_EXPORTS) -s NO_DISABLE_EXCEPTION_CATCHING -s BINARYEN_EXTRA_PASSES=--one-caller-inline-max-function-size=18500 -s LLD_REPORT_UNDEFINED -s ASSERTIONS=0 -s GL_ASSERTIONS=0
