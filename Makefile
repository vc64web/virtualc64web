...
STD       = -std=c++17
OPTIMIZE  = -O2
WASM_EXPORTS= -s EXTRA_EXPORTED_RUNTIME_METHODS=['cwrap'] -s EXPORTED_FUNCTIONS="['_main', '_wasm_toggleFullscreen', '_wasm_loadFile', '_wasm_key', '_wasm_joystick', '_wasm_reset', '_wasm_halt', '_wasm_run', '_wasm_take_user_snapshot', '_wasm_pull_user_snapshot','_wasm_user_snapshot_width', '_wasm_user_snapshot_height', '_wasm_user_snapshots_count','_wasm_pull_auto_snapshot','_wasm_auto_snapshot_width', '_wasm_auto_snapshot_height', '_wasm_auto_snapshots_count','_wasm_restore_user_snapshot','_wasm_restore_auto_snapshot']"
