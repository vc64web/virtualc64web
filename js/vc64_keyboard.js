...
function installKeyboard() {  
    ...
    [{k:'\u{2190}',c:'Delete',style:'font-weight:bold'}, {k:'1',sk:'!', c:'Digit1',cbm:'ORG',ctrl:'BLK'},{k:'2', sk:'\"', c:'Digit2', cbm:'BRN', ctrl:'WHT'},{k:'3',sk:'#',c:'Digit3', cbm:'PNK', ctrl:'RED'},{k:'4',sk:'$',c:'Digit4', cbm:'DRK<br>GRY', ctrl:'CYN'},{k:'5',sk:'%',c:'Digit5',cbm:'GRY', ctrl:'PUR'},{k:'6',sk:'&',c:'Digit6', cbm:'LGHT<br>GRN', ctrl:'GRN'},{k:'7',sk:"'",c:'Digit7', cbm:'LGHT<br>BLU', ctrl:'BLU'},{k:'8',sk:'(',c:'Digit8', cbm:'LGHT<br>GRY', ctrl:'YEL'},{k:'9',sk:')',c:'Digit9', ctrl:'RVS<br>ON'},{k:'0',c:'Digit0', ctrl:'RVS<br>OFF', cls:'key0'},{k:'+', p:'\u{253c}', cbm:'\u{2592}' ,c:'Minus'},{k:'-', p:'\u{2502}', cbm:'\u{e0dc}', c:'Equal'},{k:'\u{00a3}', p:'\u{25e4}', cbm:'\u{e0a8}', c:'pound'},{k:'Home', sk:'CLR', c:'home', style:'font-size:x-small;height:40px;padding-top:4px;'},{k:'DEL', sk:'INST',c:'Backspace',style:'font-size:x-small;height:40px;padding-top:4px;'} ], 
    ...
    [{style:'width:160px'},{k:'', c:'Space', style:'width:401px',cls:'smallkey'},{style:'width:32px'}, {k:'\u{2190}',c:'left',sym:'ArrowLeft',cls:'smallkey'},{k:'\u{2193}', c:'ArrowDown',cls:'smallkey'},{k:'\u{2192}', c:'ArrowRight',cls:'smallkey'},{style:'width:15px'}]
    ];
    var the_keyBoard='';
    keymap.forEach(row => {
